...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # رسالة ترحيب مخصصة باسمك
    welcome_text = "أهلاً بك في نظام التحكم الخاص في بوت مسابقات كوين \n\nلقد تم تحديث النظام وربط قاعدة البيانات بنجاح.\nارسل كلمة (**تحكم**) لإظهار اللوحة الرئيسية."
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "gui_view_cats":
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("➕ سؤال مباشر", callback_data=f"add_q_{cat_id}"), InlineKeyboardButton("➕ مباشر سريع", callback_data=
